...
public class RegistrationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        edt_email = view.findViewById(R.id.edt_n1);
        edt_pass = view.findViewById(R.id.edt_n2);
        edt_cpass = view.findViewById(R.id.edt_n3);
        edt_name = view.findViewById(R.id.edt_n4);
        edt_location = view.findViewById(R.id.edt_n5);
        edt_dob = view.findViewById(R.id.edt_n6);
        edt_gender = view.findViewById(R.id.edt_n7);
        btn_register = view.findViewById(R.id.btn_n1);
